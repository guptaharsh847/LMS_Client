...
<div className="w-full flex items-center justify-between pt-2">
  ...
  <h5 className={`font-Poppins text-[16px] ${isProfile && "hidden 800px:inline"} text-black dark:text-white`}>{item.purchased} Students</h5>
</div>
<div className="w-full flex items-center justify-between pt-3">
  <div className="flex">
    ...
    <h5 className={`font-Poppins mt-[-5] pl-3 text-[14px] line-through opacity-80 text-black dark:text-white`}>₹{item.estimatedPrice}</h5>
