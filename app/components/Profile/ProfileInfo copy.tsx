...
const ProfileInfo: FC<Props> = ({ avatar, user }) => {
  ...
  return (
    <>
      ...
      <div className="w-full mt-[10%] pl-[15%] absolute 800px:pl-10 pt-[100px]">
        <form onSubmit={handleSubmit}>
          <div className="800px:w-[50%] m-auto block pb-4">
            <div className="w-[100%]">
              ...
              <input
                type="text"
                className={`${styles.input} w-[50%] mb-4 800px:mb-0 800px:w-[70%]`}
                required
                value={name}
            ...
            <div className="w-[100%] pt-2">
              ...
              <input
                type="text"
                readOnly
                className={`${styles.input} w-[50%] mb-1 800px:mb-0 800px:w-[70%]`}
                required
                value={user?.email}
              />
            </div>
