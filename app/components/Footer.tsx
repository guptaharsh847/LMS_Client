...
const Footer = (props: Props) => {
  return (
    ...
    className="text-base text-black dark:text-gray-300 dark:hover:text-white">FAQ
    </Link>
    </li>
    </ul>
    </div>
  ...
  Courses
    ...
    className="text-base text-black dark:text-gray-300 dark:hover:text-white">Course DashBoard
    </Link>
    </li>
    </ul>
    </div>
  ...
  Youtube
    ...
    className="text-base text-black dark:text-gray-300 dark:hover:text-white">GitHub
    </Link>
    </li>
    </ul>
    </div>
    ...
    <p  className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
        Call us : 91-9133-453-343
    </p>
    <p  className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
        Address : Silicon City Mumbai 34535</p>
    <p  className="text-base text-black dark:text-gray-300 dark:hover:text-white pb-2">
        Mail Us : qqq@q.com
    </p>
    </div>
