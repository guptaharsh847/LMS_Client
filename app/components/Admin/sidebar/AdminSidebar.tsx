...
<Box textAlign="center">
    ...
    className="!text-[20px] text-black dark:text-[#ffffffc1] !font-Poppins capitalize" sx={{ m: "10px 0 0 0" }}>
   - {user.role}
    </Typography>
    </Box>
</Box>
...
<Box paddingLeft={isCollapsed ? undefined : "10%"}>
    ...
    className="!text-[18px] text-black dark:text-[#ffffffc1] !font-Poppins !font-[400] capitalize" sx={{ m: "15px 0 5px 25px" }}>
   {!isCollapsed && "Data"}
    </Typography>
    <Item
    title="Users"
